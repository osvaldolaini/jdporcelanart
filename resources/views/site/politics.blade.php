...
@section('body')
    ...
    <section class="section" style="background-color: #000;">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h2 class="subheading gsap-reveal-hero text-center">Política Privacidade</h2>
                    ...
                    <p>
                        A sua privacidade é importante para nós. É política do spark despachante de armas respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href=https://www.sparkdespachantedearmas.com.br/>spark despachante de armas</a>, e outros sites que possuímos e operamos.
                    </p>
                    <p>
                    ...
                    <h2 class="subheading gsap-reveal-hero text-center">
                        Política de Cookies spark despachante de armas
                    </h2>
                    <span class="gsap-reveal text-center w-100 align-items-center">
                        <picture class="lazyload img-fluid" alt="divider" width="150">
                            <source srcset="{{ url('storage/images/site/divider_alvo_gold.png') }}" />
                    ...
                    <ul>
                        ...
                        <li>
                            Cookies relacionados a boletins por e-mail<br><br> Este site oferece serviços de assinatura de boletim informativo ou e-mail e os cookies podem ser usados ​​para lembrar se você já está registrado e se deve mostrar determinadas notificações                            válidas apenas para usuários inscritos / não inscritos.<br><br>
                        </li>
                        <li>
                        ...
                        <li>
                            Cookies relacionados a formulários<br><br> Quando você envia dados por meio de um formulário como os encontrados nas páginas de contacto ou nos formulários de comentários, os cookies podem ser configurados para lembrar os detalhes do usuário                            para correspondência futura.<br><br>
                        </li>
                        <li>
                    ...
                    <p>
                        O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o spark despachante de armas oferece no site e com caráter enunciativo, mas não limitativo:
                    </p>
                    <ul>
                        <li>
                        ...
                        <li>
                            B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, ou apostas desportivas (ex.:<a href='https://ondeapostar.pt/review/betano/'> Betano</a>), jogos de sorte e azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;
                        </li>
                        <li>
                            C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do spark despachante de armas, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.
                        </li>
                    </ul>
